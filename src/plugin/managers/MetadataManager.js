...
var MetadataManager = /** @class */ (function () {
    function MetadataManager() {
        this.METADATA_KEY = "metadata-type";
    }
    /**
     * 노드에 메타데이터 설정
     */
    MetadataManager.prototype.setMetadata = function (nodeId, metadataType) {
        return __awaiter(this, void 0, void 0, function () {
            var node;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, figma.getNodeByIdAsync(nodeId)];
                    case 1:
                        node = _a.sent();
                        if (!node) {
     ...
     * 노드의 메타데이터 읽기
     */
    MetadataManager.prototype.getMetadata = function (node) {
