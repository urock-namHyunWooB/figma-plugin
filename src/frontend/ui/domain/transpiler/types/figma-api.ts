...
/**
 * Component 메타데이터 (components 맵의 값)
 */
...
/**
 * ComponentSet 메타데이터 (componentSets 맵의 값)
 */
 ...
 * 타입 가드 함수들
 */
export function isComponentSetNode(
  node: FigmaRestNode
): node is FigmaRestComponentSetNode {
  return node.type === "COMPONENT_SET";
}

export function isComponentNode(
  node: FigmaRestNode
): node is FigmaRestComponentNode {
  return node.type === "COMPONENT";
}

export function isTextNode(node: FigmaRestNode): node is FigmaRestTextNode {
  return node.type === "TEXT";
}

export function isFrameNode(node: FigmaRestNode): node is FigmaRestFrameNode {
