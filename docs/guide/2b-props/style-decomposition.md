...
2. **applyLayoutOverrides** (cross-variant): cross-depth squash에서 prune된 wrapper의 레이아웃 속성(flex-direction, gap, padding, justify-content, align-items, flex-wrap)을 해당 variant의 CSS에 복원한다.
