...
import { WrapperRoleDistinction } from "@code-generator2/layers/tree-manager/tree-builder/processors/variant-merger/match-engine/signals/WrapperRoleDistinction";
