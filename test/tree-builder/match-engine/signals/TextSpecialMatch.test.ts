...
describe("TextSpecialMatch signal", () => {
  ...
  it("returns decisive-match for TEXT pair with same name + same parent type", () => {
  ...
  it("returns neutral score 1 for non-TEXT pair", () => {
  ...
  it("returns neutral score 1 for TEXT pair with different names", () => {
    const a = textNode("a", "Label", "FRAME");
  ...
  it("returns neutral score 1 for TEXT pair with different parent types", () => {
    const a = textNode("a", "Label", "FRAME");
  ...
  it("returns neutral score 1 when parent is missing", () => {
